...
const uploadRes = await axios.post<UploadFileResponse>('/api/upload', formData, config);
    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      {!uploadResult && (
        <>
          ...
          <PaymentButton file={file} uploading={uploading} handlePaymentAndUpload={handlePaymentAndUpload} />
